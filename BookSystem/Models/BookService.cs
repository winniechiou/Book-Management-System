...
namespace BookSystem.Models
{
    public class BookService
    {
        ...
        /// 取得欲修改書籍資料
        /// </summary>
        public Models.BookUpdate GetEditById(int BookID){
            DataTable dt = new DataTable();
            string sql = @"select 
                                BD.BOOK_ID as BookID,
                                BD.BOOK_NAME as BookName,
        ...
        /// 取得借閱明細
        /// </summary>
        public List<Models.Books> GetBookLendRecords(int BookID)
        {
            DataTable dt = new DataTable();
        ...
        /// Map資料進List
        /// </summary>
        private List<Models.BookSearchArg> MapBookDataToList(DataTable employeeData)
        {
        ...
        /// Map資料
        /// </summary>
        private BookUpdate MapBookDataForUpdateToList(DataTable BookData)
        {
            BookUpdate result = new BookUpdate();
        ...
        /// Map資料進Model
        /// </summary>
        private List<Models.Books> MapBookLendRecordToList(DataTable BookData)
        {
